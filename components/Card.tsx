    ...
    return (
        <div className={`${darkTheme ? 'bg-zinc-700' : 'bg-red-600'} flex flex-col rounded-xl items-center justify-between shadow-md shadow-zinc-600 hover:scale-110 px-2 transition ease-in-out delay-150`}>
            ...
            <div className="text-white w-full font-bold text-sm flex items-center justify-center px-4 gap-3 lg:gap-4">
                <span 
                onMouseEnter={() => {setShowHp(true)}}
                onMouseLeave={() => {setShowHp(false)}} 
                ...
                <span 
                onMouseEnter={() => {setShowAttack(true)}}
                onMouseLeave={() => {setShowAttack(false)}} 
                className="flex items-center rounded-full border-2 p-3">
                    { showAttack ?
                    attack :
                    <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="20" viewBox="0 0 24 24" strokeWidth="3" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span 
                onMouseEnter={() => {setShowDefense(true)}}
                onMouseLeave={() => {setShowDefense(false)}} 
                className="flex items-center rounded-full border-2 p-3">
                    {showDefense ? 
                    defense :
                    <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="20" viewBox="0 0 24 24" strokeWidth="3" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
