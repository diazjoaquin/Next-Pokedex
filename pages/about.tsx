...
export default function About () {
    ...
    return (
        <main className="w-full h-full flex items-center justify-center">
            ...
            shadow-zinc-600
            shadow-md`}>
                <h1 className="text-white font-bold text-lg md:text-2xl">Acerca del Proyecto:</h1>
                ...
                <h3 className="text-white font-bold text-lg md:text-2xl">Tecnologías Usadas en este Proyecto:</h3>
                ...
                <h3 className="text-white font-bold text-lg md:text-2xl">Estado Actual:</h3>
