                ...
                <div className="flex h-full w-full lg:justify-end">
                    <div className="bg-black flex flex-col justify-center px-16 py-16 lg:max-w-md w-full">
                        ...
                        <div className='flex flex-row items-center gap-4 mt-8 justify-center'>
                          <div onClick={() => signIn('google', { callbackUrl: 'https://next-pokedex-red.vercel.app/auth/callback/google' })} className='w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition'>
                            <FcGoogle size={30}/>
                          </div>
                          <div onClick={() => signIn('github', { callbackUrl: 'https://next-pokedex-red.vercel.app/auth/callback/github' })} className='w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transition'>
                            <FaGithub size={30}/>
                          </div>
                        </div>
